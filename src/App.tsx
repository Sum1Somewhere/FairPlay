...
function StarRating({ value, onChange, size = "md", showNumber = true }) {
  ...
  const Logo = ({ height = 36 }) => (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      ...
      >
        ...
        <polygon points="20,4 23,18 20,22 17,18" fill="#60b8f0" />
        <polygon points="20,36 17,22 20,18 23,22" fill="#3a7fc1" />
        <polygon points="4,20 18,17 22,20 18,23" fill="#3a7fc1" />
        <polygon points="36,20 22,23 18,20 22,17" fill="#60b8f0" />
      ...
      >
        <span style={{ color: "#1e3a5f" }}>Fair</span>
        <span style={{ color: "#60b8f0" }}>Play</span>
      </span>
    </div>
  );
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 12, color: "#9CA3AF" }}>
          ClubIQ · The trusted review platform for youth travel sports &
